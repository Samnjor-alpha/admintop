...
alert('No Market Categories added');
    ...
    if (empty($_POST['mrktdesc']) || empty($_POST['mrkt']) || empty($_POST['mrkt_categ'])) {
        ...
        $sql_e = "SELECT * FROM ftmarkets WHERE mrkt_name ='$mrktname'";
        ...
        if (mysqli_num_rows($res_e)>0){
            ...
            if(empty($error)) {
                ...
                $sql = "INSERT INTO ftmarkets SET mrktcateg_id='$mrkt_categid',mrkt_name ='$mrktname',mrkt_desc='$mrktdesc'";
