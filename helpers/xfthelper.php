...
$drawteamtips=mysqli_query($conn, "SELECT * FROM  predictions	INNER JOIN fixtures ON fixtures.fix_code = predictions.game_id
WHERE DATE(fixtures.kick_off) >='$today'  and predictions.tip_id = '$id' LIMIT $offset, $total_records_per_page");
