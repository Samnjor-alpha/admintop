...
function checkx2($gameid,$tipid,$mrktid){
    global $conn;
...
$hometeamdrawtips=mysqli_query($conn, "SELECT * FROM  predictions	INNER JOIN fixtures ON fixtures.fix_code = predictions.game_id
