    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <li class="breadcrumb-item active">(Draw) Predictions</li>
                </ol>

                <? if (mysqli_num_rows($drawteamtips)>0){
                    while ($tipsrow=$drawteamtips->fetch_assoc()){
