...
include '../helpers/12fthelper.php';
?>
        ...
        <main>
            <div class="container-fluid">
                ...
                <ol class="breadcrumb mt-4 mb-4">
                    <li class="breadcrumb-item active">(1 or 2) Predictions</li>
                </ol>

                <? if (mysqli_num_rows($homeawaytips)>0){
                    while ($tipsrow=$homeawaytips->fetch_assoc()){
                        $game=mysqli_query($conn,"select * from fixtures where fix_code='".$tipsrow['game_id']."'");
                        $gamerow=$game->fetch_assoc();
                        check1or2($tipsrow['game_id'],$tipsrow['id'],$tipsrow['tip_id'])
                        ?>
