        ...
        <main>
            <div class="container-fluid">
                ...
                <ol class="breadcrumb mt-4 mb-4">
                      <li class="breadcrumb-item active">(Away Team to win) Predictions</li>
                </ol>

                <? if (mysqli_num_rows($awayteamwintips)>0){
                    while ($tipsrow=$awayteamwintips->fetch_assoc()){
