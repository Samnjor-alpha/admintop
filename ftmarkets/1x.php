...
include '../helpers/1xfthelper.php';
?>
        ...
        <main>
            <div class="container-fluid">
                ...
                <ol class="breadcrumb mt-4 mb-4">
                    <li class="breadcrumb-item active">(1X) Predictions</li>
                </ol>

                <? if (mysqli_num_rows($hometeamdrawtips)>0){
                    while ($tipsrow=$hometeamdrawtips->fetch_assoc()){
                        $game=mysqli_query($conn,"select * from fixtures where fix_code='".$tipsrow['game_id']."'");
                        $gamerow=$game->fetch_assoc();
                        check1x($tipsrow['game_id'],$tipsrow['id'],$tipsrow['tip_id'])
                        ?>
