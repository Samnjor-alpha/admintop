...
include '../helpers/edithtmarket-helper.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="country" name="mrkt_categ" class="form-control" required>
                                                <option value="<? echo $row_htmrkt['mrktcateg_id'] ?>" disabled selected> <?  echo getmarketcategById($row_htmrkt['mrktcateg_id']) ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-2" value="<?= isset($_POST['mrkt']) ? $_POST['mrkt'] : $row_htmrkt['mrkt_name']; ?>" id="mrkt" name="mrkt" type="text" placeholder="Draw,Over 1.5, Home team win" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control py-2"  id="amrkt" name="mrktdesc" type="text" placeholder="About Market"><?= isset($_POST['mrktdesc']) ? $_POST['mrktdesc'] : $row_htmrkt['mrkt_desc']; ?></textarea>
                                        </div>

                                        <div class="form-group mt-4 mb-0"><button id="btnadd" type="submit" name="uphtmrkt"  class="btn btn-primary btn-block">Update HT Market</button></div>
...
// add spinner to button
            $(this).html(
                '<i class="fad fa-bookmark"></i> Updating HT Market....'
            );
        });
    });
</script>
