...
include '../helpers/editftmarket-helper.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
                            ...
                            <div  id="s" class="card rounded-top mt-4">
                                ...
                                <div class="card-body">
                                    <form method="post" action="">
                                        ...
                                        <div class="form-group mt-4 mb-0"><button id="btnadd" type="submit" name="upftmrkt"  class="btn btn-primary btn-block">Update FT Market</button></div>
...
// add spinner to button
            $(this).html(
                '<i class="fad fa-bookmark"></i> Updating FT Market....'
            );
        });
    });
</script>
